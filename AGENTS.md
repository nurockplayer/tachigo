...
> **GitHub 自動 review（非 conversation 模式）**：有 blocker 時結語使用「Recommend changes requested」；無 blocker 時結語使用「Safe to merge after human approval」，不詢問用戶。
