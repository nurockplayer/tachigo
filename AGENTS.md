...
Autonomous / AWP / Hybrid AWP 啟動請先讀 [docs/ai/autonomous-bootstrap.md](docs/ai/autonomous-bootstrap.md)。該文件是單一入口；讀完後仍必須展開到 `AGENTS.md`、`.github/PULL_REQUEST_TEMPLATE.md`、[docs/ai/codex-autonomous-workflow.md](docs/ai/codex-autonomous-workflow.md)、[docs/ai/autonomous-pr-gates.md](docs/ai/autonomous-pr-gates.md) 與 [docs/pr-scope-policy.md](docs/pr-scope-policy.md)。
