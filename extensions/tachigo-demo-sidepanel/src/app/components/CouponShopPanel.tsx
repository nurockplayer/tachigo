...
export function CouponShopPanel({
  ...
  const selectedCoupon = useMemo(
    () =>
      COUPON_METAS.find((coupon) => coupon.id === selectedId) ??
      COUPON_METAS[0],
    [selectedId],
  );
  ...
  return (
    <div
      style={{
        ...
        color: "#f8f1df",
        // 與 hudPanelBackground 最底層色接近，整張裝飾背景另層 opacity 0.5 時不會透怪色
        background: "#060510",
    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            style={{ fontSize: 8, color: "#b794ff", letterSpacing: "0.12em" }}
          >
            {t("coupon.header")}
          </div>
        </div>
        ...
        >
          <div
            style={{
              ...
              background:
                "linear-gradient(180deg, rgba(145,70,255,0.16) 0%, rgba(255,255,255,0.03) 100%)",
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
              <div style={{ fontSize: 32, color: "#fff2bf", lineHeight: 1 }}>
                {tcgBalance.toFixed(2)}
              </div>
              <div
                style={{
                  fontSize: 8,
          ...
          <div
            style={{
              ...
              padding: 14,
              background:
                "linear-gradient(135deg, rgba(145,70,255,0.22) 0%, rgba(25,12,44,0.92) 100%)",
          ...
          >
            ...
            <div style={{ fontSize: 14, color: "#fff7da", lineHeight: 1.5 }}>
              {t(itemPath("title"))}
            </div>
            <div
              style={{
                fontSize: 7,
                color: "rgba(225,218,255,0.74)",
                lineHeight: 1.8,
              }}
            >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            <div
              style={{ fontSize: 7, color: "#9146FF", letterSpacing: "0.14em" }}
            >
              {t("coupon.listTitle")}
            </div>
              ...
              return (
                <button
                  ...
                  style={{
                    textAlign: "left",
                    border: isSelected
                      ? "1px solid rgba(225,176,82,0.36)"
                      : "1px solid rgba(205,164,92,0.14)",
                ...
                >
                  ...
                  >
                    ...
                    >
                      {isRedeemed
                        ? t("coupon.redeemed")
                        : t(`coupon.items.${coupon.itemKey}.tag`)}
                    </div>
                  </div>
                </button>
              );
