...
| Atlas migration tooling | 75-85% | #588 已補 Atlas apply / Docker runtime runner / backend gate；production deploy workflow 與 rollback runbook 仍未納入 |
...
2. Backend safety
   ...
   - Merge `#588` 完成 `#463` runtime Atlas apply path；後續另補 production deploy workflow、baseline/runbook 與 rollback procedure
