...
CREATE INDEX IF NOT EXISTS idx_raffle_prize_tiers_raffle_id
    ON raffle_prize_tiers (raffle_id, position);

ALTER TABLE raffle_draws
    ADD COLUMN IF NOT EXISTS prize_tier_id UUID REFERENCES raffle_prize_tiers(id) ON DELETE SET NULL;
